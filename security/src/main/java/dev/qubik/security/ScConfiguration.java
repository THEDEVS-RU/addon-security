...
@PropertySource(name = "dev.qubik.security", value = "classpath:/dev/qubik/security/module.properties")
public class ScConfiguration {
    ...
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("dev.qubik.security"));
    ...
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("dev.qubik.security"));
        return actions;
    }
}
